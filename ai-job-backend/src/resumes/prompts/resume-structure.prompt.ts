...
11. 重点识别中文简历中的“项目经历”“项目经验”“项目实践”“作品”“代表项目”“校园项目”“实习项目”等板块，并放入 projects。
12. 如果项目写在工作经历下面，但有明确项目名称，也应同时提取到 projects；不要因为它属于某段工作经历就忽略项目。
13. projects.name 必须来自原文中的项目名称或作品名称；如果无法判断项目名称，不要编造名称。
